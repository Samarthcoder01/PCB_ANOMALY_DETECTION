...
# Additional imports for enhanced interface
...
WINDOW_WIDTH = 900  # Increased width to prevent overlap
WINDOW_HEIGHT = 550 # Further increased height to prevent overlap
...
# Configure colors with updated professional palette
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
RED = (255, 77, 77)  # Bright red
GREEN = (76, 175, 80)  # Fresh green
BLUE = (33, 150, 243)  # Sky blue
DARK_BLUE = (13, 71, 161)  # Deep blue
LIGHT_BLUE = (173, 216, 230)  # Light blue
NAVY = (0, 38, 77)  # Navy blue
GOLD = (255, 215, 0)  # Gold
TABLE_BG = (30, 30, 45)  # Darker background for table
TABLE_BORDER = (70, 130, 180)  # Steel blue border
...
def show_welcome_animation():
    ...
    while not done:
        ...
        system_text = welcome_font.render("PCB Anomaly Detection", True, WHITE)
        creator_text = creator_font.render("Created by Samarth Jadhav", True, WHITE)
...
def draw_header(surface):
    ...
    glow_text = title_font.render("PCB Analysis System", True, glow_color)
    glow_rect = glow_text.get_rect(center=(WINDOW_WIDTH//2, 40))
    surface.blit(glow_text, glow_rect)
    
    # Draw main text
    title_text = "PCB Analysis System"
...
def draw_footer(surface):
    ...
    footer_text = "Created by Samarth Jadhav | PCB Anomaly Detection | © 2024"
...
def main():
    ...
    buttons = {
        'start_stop': ModernButton(center_x - 2.5 * button_spacing, button_y, 120, 40, "Start/Stop", BLUE),
        'threshold_up': ModernButton(center_x - button_spacing, button_y, 40, 40, "+", GREEN),
        'threshold_down': ModernButton(center_x - button_spacing + 50, button_y, 40, 40, "-", RED),
        'upload': ModernButton(center_x + 0.5 * button_spacing, button_y, 120, 40, "Upload", (0, 31, 63)),
        'results': ModernButton(center_x + 1.5 * button_spacing, button_y, 120, 40, "Results", BLUE),
        'record': ModernButton(center_x + 2.5 * button_spacing, button_y, 120, 40, "Record", RED),
        'graph': ModernButton(center_x + 3.5 * button_spacing, button_y, 120, 40, "Graph", GREEN),
